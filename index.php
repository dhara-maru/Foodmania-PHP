                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <img src="images/icn.png" style="margin-left:-30px">
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p> 789, 5th Main Road, 4th Block, Koramangala, Bangalore, Karnataka 560034</p>
                                    <h5>Phone: 9877346974</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Foodmania.com</h5>
                                   <p>Craving Satisfaction? FoodMania Delivers Delight to Your Doorstep!</p>
                                </div>
                    </div>
                </div>
